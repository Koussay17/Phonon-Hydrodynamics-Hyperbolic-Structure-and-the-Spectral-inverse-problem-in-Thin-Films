...
lui faut un temps $\tau_R$ pour répondre à un gradient. En l'absence du terme
non local, le système de Cattaneo est hyperbolique et sa vitesse est finie.
Avec $\ell>0$, GK comporte une diffusion du flux et n'a pas cette propriété
de propagation finie ; voir la note de partie II.
...
Les coefficients suivants sont ceux de la fermeture isotrope dans la limite
de processus normaux dominants (Lebon et Dauby, Phys. Rev. A \textbf{42}, 4710, 1990).
Leur dérivation complète depuis la hiérarchie des moments reste à rédiger ;
cette note en expose la structure, sans prétendre accomplir la fermeture.
...
$b,\xi_1,\tau_R$ et $\tau_\ell=3\ell^2/a$.
...
\vspace{4pt}
\noindent\small
Références à vérifier à la source avant citation. Notes associées : \texttt{08\_\allowbreak Le\_\allowbreak gaz\_\allowbreak de\_\allowbreak phonons},
