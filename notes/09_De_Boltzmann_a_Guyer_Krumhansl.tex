...
Les temps $\tau_N$ et $\tau_R$ qui apparaissent ensuite sont par conséquent des \textbf{moyennes
pondérées sur le spectre}, non des grandeurs microscopiques élémentaires. Toute condition portant
sur leur rapport --- et la partie~IV en produit une --- est une condition sur ces moyennes, non sur
chaque mode.
...
\textbf{La direction hors plan est celle du présent travail} : film mince sur substrat, flux
perpendiculaire au film. Le cadre de Callaway y porte donc une erreur propre de l'ordre de dix pour
cent, indépendante de toute considération d'identifiabilité, et antérieure à toute mesure.

\subsection{Portée}

Cette limite n'invalide pas la chaîne exposée ici : elle en fixe la précision. Une valeur de temps de
relaxation obtenue dans ce cadre ne peut pas prétendre à mieux que l'ordre de grandeur de cet écart,
quelle que soit la qualité de l'inversion qui l'a produite.

Elle borne également ce qu'une confrontation expérimentale peut établir : un désaccord inférieur à
dix pour cent entre modèle et mesure ne constitue pas une réfutation.
