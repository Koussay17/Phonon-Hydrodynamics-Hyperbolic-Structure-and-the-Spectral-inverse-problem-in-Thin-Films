...
{\normalsize Document d'accompagnement des notes 01 à 04 sur Krapez (2019, en ligne 2018)}\\[2pt]
{\small 8 septembre 2026}
\end{center}

\vspace{6pt}

Les erreurs décrites dans la première partie concernent les anciennes versions
des notes 01 à 04 ; les fichiers actuels intègrent les corrections.
...
\textbf{Rappel sur le wronskien.} Pour deux solutions d'une même EDO linéaire régulière du second ordre, sa nullité caractérise la dépendance linéaire ; ce n'est pas un critère universel pour deux fonctions quelconques. Pour une équation en forme normale --- sans terme de dérivée première, ce qui est
...
C'est le premier test à écrire dans \texttt{tests/\allowbreak }, avant toute autre ligne de code. Un quadripôle
...
& « La transformation de Liouville, établie pour l'équation de la chaleur par Krapez (2019, en ligne 2018) » \\
\addlinespace
...
\section*{Portée de la version corrigée --- 15 septembre 2026}
Les corrections de signe sont historiques : les notes associées les intègrent désormais. Le wronskien caractérise l'indépendance pour les solutions d'une même EDO linéaire du second ordre sur un intervalle régulier, pas pour deux fonctions arbitraires.
\end{document}
