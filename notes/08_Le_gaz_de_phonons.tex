...
Pour le nitrure d'aluminium, $\Theta_D = 988$~K. À température ambiante, le cristal est donc
nettement en dessous de sa température de Debye, et une fraction appréciable des modes de haute
pulsation contribue peu. Cette valeur élevée a une conséquence pratique : la diffusion par les
défauts ponctuels y conserve une influence sensible jusqu'à l'ambiante, là où elle serait masquée
par les processus umklapp dans un cristal de $\Theta_D$ plus basse.
...
Cette condition concerne la longueur d'onde et la description semi-classique.
Une épaisseur comparable au libre parcours remet en cause l'approximation diffusive,
mais pas automatiquement l'équation de Boltzmann : celle-ci peut décrire le transport
balistique avec des conditions de bord appropriées. Ne pas confondre longueur d'onde
et libre parcours.
...
\addlinespace
Température de Debye, AlN & valeur mesurée & $988$ K \\
\addlinespace
Temps effectif illustratif & sans moyenne spectrale établie & $10^{-12}$ à $10^{-11}$ s \\
\addlinespace
Longueur grise illustrative & $\Lambda = v\,\tau$ & $10^{-8}$ à $10^{-7}$ m \\
\addlinespace
Capacité volumique, AlN & $\rho c_p$ & $2{,}4\times10^{6}$ J\,m$^{-3}$K$^{-1}$ \\
\addlinespace
Conductivité, AlN & dépend de la qualité du cristal & $150$ à $321$ W\,m$^{-1}$K$^{-1}$ \\
\bottomrule
\end{tabularx}
\end{center}
