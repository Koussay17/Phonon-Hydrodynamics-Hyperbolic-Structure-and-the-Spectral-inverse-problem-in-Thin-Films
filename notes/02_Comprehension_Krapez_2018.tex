...
\begin{document}
\begin{center}
{\Large\bfseries Compréhension de l'article --- Krapez (2019, en ligne 2018)}\\[4pt]
...
Cette dérivation concerne Fourier. Dans un milieu gradué, les valeurs de diffusivité aux deux faces ne déterminent pas l'intégrale de Liouville ; une loi spatiale ou cette intégrale doit être spécifiée.
\end{document}