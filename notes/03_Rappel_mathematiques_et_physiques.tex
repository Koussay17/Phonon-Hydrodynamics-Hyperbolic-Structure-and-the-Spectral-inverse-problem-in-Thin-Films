...
Pour deux solutions de la même EDO linéaire régulière du second ordre, le wronskien est nul si et seulement si elles sont linéairement dépendantes. Cet énoncé ne vaut pas pour deux fonctions arbitraires. Pour une équation en forme normale, dépourvue de terme en dérivée première, le
...
Le critère du wronskien s'applique ici à deux solutions de la même EDO linéaire régulière. Les exemples numériques sont illustratifs ; une analogie de Schrödinger ne transfère pas automatiquement les résultats spectraux quantiques au problème thermique.
\end{document}