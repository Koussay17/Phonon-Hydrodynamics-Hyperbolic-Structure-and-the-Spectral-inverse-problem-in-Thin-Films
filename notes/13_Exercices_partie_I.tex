...
quelle que soit la valeur commune des deux temps.}
...
rapport de temps de collision, qui varie avec la température.}
...
utilisant le bilan d'énergie et la loi de Cattaneo. Linéariser à la fin seulement.
...
Comparer à l'épaisseur d'un film de 500~nm et conclure sur la validité de la description diffusive.
...
juste à droite du sommet. À cette abscisse la fenêtre mesure un quart de décade.}

\vspace{8pt}
\noindent\small
Notes associées : \texttt{08\_Le\_gaz\_de\_phonons}, \texttt{09\_De\_Boltzmann\_a\_Guyer\_Krumhansl},
\texttt{11\_Note\_partie\_II}, \texttt{12\_Note\_partie\_III}. Vérifications numériques
correspondantes : \texttt{tests/test\_guyer\_krumhansl.py}, \texttt{tests/test\_admissibility.py}.
