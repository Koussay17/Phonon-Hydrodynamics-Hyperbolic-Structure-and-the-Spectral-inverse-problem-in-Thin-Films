...
les calculs intermédiaires. La note~14 fournit maintenant le calcul détaillé de la fermeture.
Les exercices 12--16 et 20--23 utilisent la convention historique ; refaire aussi la conversion conservatrice.
...
\rep{$\omega \simeq v|k|$ avec $v = a\sqrt{C/M}$.}

\subsection*{Exercice 3 --- Vitesse de groupe au bord de zone}

Pour $0<k\le\pi/a$, calculer $v_g = d\omega/dk$ et montrer qu'elle s'annule en $k = \pi/a$. Décrire le mouvement des
...
\rep{$\omega$ paire, $\mathbf{v}_g$ impaire, intégrande impaire, intégrale nulle. \textbf{Un flux non nul signale un déséquilibre ; un flux nul ne suffit pas à prouver l'équilibre.}}
...
Écrire la partie principale du système de Cattaneo en variables $(u, q)$ sous la forme
