...
L'invariance porte sur les paramètres libres de la géométrie 1D considérée. Une épaisseur ou une propriété connue indépendamment réduit cette liberté. Le principe de transposition figure page 1 du préprint de trois pages.
\end{document}
