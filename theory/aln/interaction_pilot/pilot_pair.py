...
ph.sigmas=[0.05,0.1,0.2]
ph.run_thermal_conductivity(temperatures=[300],grid_points=[1,2],
...
record={"scope":"single-point coarse-mesh interaction/self-energy export; no conductivity or hydrodynamic conclusion",
    ...
    "inputs":input_record,"settings":{"mesh":[3,3,3],"grid_points":[1,2],"temperature_K":300,
    "sigma_THz":[0.05,0.1,0.2],"backend":"Rust","symmetrize_fc":False,"NAC":True},
...
(ROOT/"pair-run.json").write_text(json.dumps(record,indent=2)+"\n",encoding="utf-8")
