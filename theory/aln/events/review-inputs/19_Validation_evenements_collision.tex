...
{\small Partie I --- 18 septembre 2026}
\end{center}
...
\[
 \epsilon^T\dot n
 =-k_BT\,\Delta\,\Gamma(1+N_i)N_jN_k(e^{-\Delta}-1)>0 .
\]
...
Le code contrôle également $|\Delta|$. Cette tolérance couvre l'arrondi
numérique ; elle ne représente pas une largeur spectrale physique.
...
avec une arithmétique à 100 chiffres. Ils contrôlent énergie, impulsion
...
le rapport bibliographique de la campagne.
